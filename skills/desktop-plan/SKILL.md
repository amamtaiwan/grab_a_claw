...
|---|---|---|
| `trash-candidate` | `trash` | `/sandbox/demo/trash/` |
...
```json
[
  {"file": "old_disk.iso", "action": "trash",      "from": "/sandbox/demo/desktop/old_disk.iso", "to": "/sandbox/demo/trash/old_disk.iso", "reason": "trash-candidate (>90d old)"},
